...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Sun Oct 28 05:25:59 PDT 2012
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x125D, 0x1969, "ES1961", "Solo-1 PCI AudioDrive family" } ,
	...
	{ 0x8086, 0x1050, "B026144&REV_02", "PRO/100 VE Network Connection" } ,
	...
	{ 0x8086, 0x1e31, "Intel USB 3.0 eXtensible Host Controller", "Intel USB 3.0 eXtensible Host Controller" } ,
	{ 0x8086, 0x1E3A, "1", "PCI Simple Communications Controller" } ,
	...
	{ 0x8086, 0x24C5, "82801DBM SoundMAXController (ICH4-M B0 step)", "Realtek AC97 or VIA Vinyl 700b" } ,
	...
	{ 0x8086, 0x27d8, "FF311179", "Realtek High Definition Audio Driver FF311179" } ,
	...
	{ 0x8086, 0x8086, "2200bghttp://www.pcidatabase.com/update_device.php", "PCI Simple Communications Controller" } ,
	...
	{ 0x15DD, 0x8384, "v1.0", "Intel Audio Studio" } ,
	{ 0x15DD, 0x9876, "1", "1" } ,
	...
	{ 0x1180, 0x0592, "Rl5C592", "Rioh Memory Stick Controller" } ,
	...
	{ 0x067B, 0x25a1, "PL-25A1", "Prolific PCLinq3 USB Transfer Cable Driver" } ,
	...
	{ 0x197B, 0x0260, "JMC2XX", "JMC260 PCI Express Fast Ethernethc" } ,
	...
	{ 0x05ac, 0x1297, "Apple iPhone", "Apple iPhone" } ,
	...
	{ 0x10EC, 0x0268, "High Definition Audio Codecs", "High Definition Audio Codecs" } ,
	{ 0x10EC, 0x0269, "ALC269", "Realtek High Definition audio" } ,
	{ 0x10EC, 0x0270, "?", "Realtek High Definition Audio " } ,
	{ 0x10EC, 0x0272, "ALC272X", "Realtek High Definition audio" } ,
	{ 0x10EC, 0x0532, "RTL8723AE", "BT combo mini pcie card" } ,
	{ 0x10EC, 0x0662, "Realtek AC97Audio ", "Realtek 171 High De" } ,
	...
	{ 0x10EC, 0x8136, "RTL8102E", "Realtek 10/100/1000 PCI-E NIC Family" } ,
	{ 0x10EC, 0x8139, "RTL8139", "Realtek RTL8139 Family PCI Fast Ethernet NIC" } ,
	{ 0x10EC, 0x8167, "RTL8167", "Realtek RTL8169/8110" } ,
	{ 0x10EC, 0x8168, "RTL8167", "PCIe Gigabit Ethernet Family Controller" } ,
	{ 0x10EC, 0x8171, "8136", "Realtek RTL8191SE &#1041;&#1077;&#1089;&#1087;&#1088;&#1086;&#1074;&#1086;&#1076;&#1085;&#1086;&#108" } ,
	...
	{ 0x0cf3, 0x3000, "unknown (fujitsu lifebook)", "unknown device" } ,
	...
	{ 0x1B21, 0x1042, "?", "AS Media Universal Serial Bus Controller" } ,
	...
	{ 0x168C, 0x0007, "AR5B97", "Wireless Network Adapter" } ,
	...
	{ 0x168C, 0x002A, "2", "Atheros AR5BXB92 " } ,
	{ 0x168C, 0x002B, "E035105B", "Atheros AR5B95 Wireless LAN 802.11 a/b/g/n Controller" } ,
	{ 0x168C, 0x002C, "AR5008", "Wireless 802.11 a/b/g/n Dualband Network Adapter (PCI-Express)" } ,
	{ 0x168C, 0x002D, "AR9287 rev01", "802.11b/g/n" } ,
	{ 0x168C, 0x002E, "AR9285", "Atheros ar9285 PCI Capabilities:  Offset ID Description " } ,
	{ 0x168C, 0x0030, "1102 - 1103", "Killer Wireless - N" } ,
	{ 0x168C, 0x0032, "0x0032C", "AR9485WB-EG Wireless Network Adapter" } ,
	...
	{ 0x1002, 0x4379, "SB450", "SATA/Raid controller--1" } ,
	...
	{ 0x1002, 0x6759, "-", "AMD Radeon HD 6570" } ,
	...
	{ 0x1006, 0x3044, "n/a", "OHCI Compliant IEEE 1394 Host Controller" } ,
	{ 0x1008, 0x9876, "23", "23" } ,
	...
	{ 0x1028, 0x3582, "inspiron 510m", "video controller" } ,
	...
	{ 0x103C, 0x1028, "ACPI/HPQ0004/3&33fd", "HP ProtectSmart Hard Drive Protection - HP 3D DriveGuard" } ,
	...
	{ 0x1043, 0x82c6, "RTL8168", "Gigabit Ethernet NIC(NDIS 6.0)" } ,
	...
	{ 0x104D, 0x8009, "CXD1947", "PCI bus 5" } ,
	...
	{ 0x1317, 0x1985, "AN985", "CardBus 10/100 Fast Ethernet &#1050;&#1086;&#1085;&#1090;&#1088;&#1086;&#1083;&#1083;&#1077;&#1088;" } ,
	...
	{ 0x109E, 0x036C, "th&#305;k", "" } ,
	{ 0x109E, 0x036E, "25878-13", "video capture device PINNAcle PCTV/PRO PCI" } ,
	...
	{ 0x10DE, 0x0028, "0DF4", "MCP67 High Definition Audio" } ,
	...
	{ 0x10DE, 0x0425, "NVIDIA 8600 GS", "NVIDIA 8600 GS" } ,
	...
	{ 0x10DE, 0x1244, "unknown", "GeForce  GTX 550" } ,
	...
	{ 0x10E6, 0x5209, "CMI8738/PCI C3DX", "C-Media Audio Controller" } ,
	...
	{ 0x1106, 0x1106, "VT1705", "VIA HD Audio Deck VT1708B" } ,
	...
	{ 0x1106, 0x3059, "VT8235", "VIA AC97 or VIA Vinyl (or Tremor) Audio VT1612A, VT1613, VT1616/B, VT1617/A, VT1618 - VIA SoundMAX R" } ,
	...
	{ 0x14E4, 0x170C, "pci VEN 4348 DEV 5053", "Broadcom 440x 10/100 Integrated Controller" } ,
	...
	{ 0x14E4, 0x432B, "4322", "WIRELESS for Hp pavilion, Wireless for macbook pro (late 2009 model), Wireless for Dell E6500,E6400" } ,
	...
	{ 0x14E4, 0x4358, "BCM943227HM4L", "Broadcom 802.11n WLAN module | http://global-download.acer.com/GDFiles/Driver/Wireless%20LAN/Wireles" } ,
	...
	{ 0x14E4, 0x4727, "Broadcom 14E4", "WLAN Broadcom 4313 802.11 Express" } ,
	...
	{ 0x1131, 0x7231, "Philips 7231/726x-Series", "Medion DVB-T / S Karte. " } ,
	...
	{ 0x11D4, 0x1988, "AD1981A", "HD Audio Codec" } ,
...
// Use this value for loop control during searching:
#define	PCI_COMMANDFLAGS_LEN	(sizeof(PciCommandFlags)/sizeof(const char *))
...
// Use this value for loop control during searching:
#define	PCI_STATUSFLAGS_LEN	(sizeof(PciStatusFlags)/sizeof(const char *))
...
// Use this value for loop control during searching:
#define	PCI_DEVSELFLAGS_LEN	(sizeof(PciDevSelFlags)/sizeof(const char *))
